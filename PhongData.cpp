...
{
    globalPhongData.NumLights = 7;     // Should be enough lights for most 155A programming projects
...
void MySetupLights()
{
    ...
    myLights[3].DiffuseColor.Set(1.0, 1.0, 1.0);      // Very light gray
    myLights[3].SpotCosCutoff = 0.96f;
    myLights[3].IsSpotLight = true;
    myLights[3].SpotExponent = 1.0f;
    myLights[3].IsEnabled = true;

    myLights[4].DiffuseColor.Set(1.0, 1.0, 1.0);      // Very light gray
    myLights[4].SpotCosCutoff = 0.96f;
    myLights[4].IsSpotLight = true;
    myLights[4].SpotExponent = 1.0f;
    myLights[4].IsEnabled = true;

    myLights[5].DiffuseColor.Set(1.0, 1.0, 1.0);      // Very light gray
    myLights[5].SpotCosCutoff = 0.96f;
    myLights[5].IsSpotLight = true;
    myLights[5].SpotExponent = 1.0f;
    myLights[5].IsEnabled = true;

    myLights[6].DiffuseColor.Set(1.0, 1.0, 1.0);      // Very light gray
    myLights[6].SpotCosCutoff = 0.96f;
    myLights[6].IsSpotLight = true;
    myLights[6].SpotExponent = 1.0f;
    myLights[6].IsEnabled = true;
...
void LoadAllLights() 
{
    ...
    myLights[3].SetPosition(viewMatrix, VectorR3(0.0, 6.0, 0.0));
    myLights[3].SetSpotlightDirection(viewMatrix, VectorR3(0.0, -1.0, -2));
    myLights[3].LoadIntoShaders(3);

    myLights[4].SetPosition(viewMatrix, VectorR3(0.0, 6.0, 0.0));
    myLights[4].SetSpotlightDirection(viewMatrix, VectorR3(-2, -1.0, 0));
    myLights[4].LoadIntoShaders(4);

    myLights[5].SetPosition(viewMatrix, VectorR3(0.0, 6.0, 0.0));
    myLights[5].SetSpotlightDirection(viewMatrix, VectorR3(2, -1.0, 0));
    myLights[5].LoadIntoShaders(5);

    myLights[6].SetPosition(viewMatrix, VectorR3(0.0, 6.0, 0.0));
    myLights[6].SetSpotlightDirection(viewMatrix, VectorR3(0, -1.0, 0));
    myLights[6].LoadIntoShaders(6);
}
